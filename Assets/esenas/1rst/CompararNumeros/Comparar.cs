    ...
    void verificarSeleccion()
    {
        ...
        if (respuestas.Count > 0)
        {
            ...
            for (int x = 0; x < respuestas.Count; x++)
            {
                ...
                if (respuestas[x].gameObject.GetComponent<Caracteristica>().valor == -1)
                {
                    if (respuestas[x].gameObject.GetComponent<DAD_Comparacion1>().bloqueado == true)
                    {
                        CompararNumeros();

                        if (respuestas[x].gameObject.GetComponent<Caracteristica>().valor == respuestaComparacion)
                        {
                ...
                if (respuestas[x].gameObject.GetComponent<Caracteristica>().valor == 0)
                {
